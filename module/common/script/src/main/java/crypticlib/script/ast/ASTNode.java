...
public abstract class ASTNode {
    ...
    public static final class FunctionCallNode extends ASTNode {
        ...
        public FunctionCallNode(String name, List<ASTNode> args, int line) {
            super(line);
            this.name = name;
            this.args = args;
        }
    ...
    public static final class IfNode extends ASTNode {
        ...
        public IfNode(ASTNode condition, List<ASTNode> thenBody,
                      List<ASTNode> elseBody, int line) {
            super(line);
    ...
    public static final class VariableDeclarationNode extends ASTNode {
        private final String variableName;
        private final ASTNode value;

        public VariableDeclarationNode(String variableName, ASTNode value, int line) {
            super(line);
    ...
    /**
     * 变量赋值（不需要 var，但变量必须已声明）
     */
    public static final class VariableAssignmentNode extends ASTNode {
        private final String variableName;
        private final ASTNode value;

        public VariableAssignmentNode(String variableName, ASTNode value, int line) {
            super(line);
            this.variableName = variableName;
            this.value = value;
        }
