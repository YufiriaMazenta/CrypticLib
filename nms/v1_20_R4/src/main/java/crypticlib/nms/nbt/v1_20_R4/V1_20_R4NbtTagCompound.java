...
public class V1_20_R4NbtTagCompound extends NbtTagCompound {

    public V1_20_R4NbtTagCompound() {
        super(V1_20_R3NbtTranslator.INSTANCE);
    }

    public V1_20_R4NbtTagCompound(Object nmsNbtCompound) {
        super(nmsNbtCompound, V1_20_R3NbtTranslator.INSTANCE);
    }

    public V1_20_R4NbtTagCompound(Map<String, Object> nbtValueMap) {
        super(nbtValueMap, V1_20_R3NbtTranslator.INSTANCE);
    }

    public V1_20_R4NbtTagCompound(String mojangson) {
        super(mojangson, V1_20_R3NbtTranslator.INSTANCE);
    }
    ...
    public NbtTagCompound clone() {
        return new V1_20_R4NbtTagCompound(toString());
    }
