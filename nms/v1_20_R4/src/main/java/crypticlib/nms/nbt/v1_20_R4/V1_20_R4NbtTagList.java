...
public class V1_20_R4NbtTagList extends NbtTagList {

    public V1_20_R4NbtTagList(List<Object> nbtList) {
        super(nbtList, V1_20_R3NbtTranslator.INSTANCE);
    }

    public V1_20_R4NbtTagList(Object nmsNbtList) {
        super(nmsNbtList, V1_20_R3NbtTranslator.INSTANCE);
    }

    public V1_20_R4NbtTagList() {
