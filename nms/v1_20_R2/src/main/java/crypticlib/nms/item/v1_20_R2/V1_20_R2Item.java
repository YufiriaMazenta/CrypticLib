...
public class V1_20_R2Item implements Item {
    ...
    public V1_20_R2Item(ItemStack itemStack) {
        ...
        this.nbtCompound = new V1_20_R2NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).w());
    }

    public V1_20_R2Item(String material, AbstractNbtTagCompound nbtCompound) {
