...
public class V1_20_R2Item extends Item {
    ...
    public V1_20_R2Item(ItemStack itemStack) {
        super(itemStack.getType().name(), new V1_20_R2NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).w()), itemStack.getAmount());
    }
    ...
    public V1_20_R2Item(String material, NbtTagCompound nbtTagCompound, Integer amount) {
