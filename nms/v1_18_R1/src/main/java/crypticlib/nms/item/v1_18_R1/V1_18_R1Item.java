...
public class V1_18_R1Item extends Item {
    ...
    public V1_18_R1Item(ItemStack itemStack) {
        super(itemStack.getType().name(), new V1_18_R1NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).t()), itemStack.getAmount());
    }
    ...
    public V1_18_R1Item(String material, NbtTagCompound nbtTagCompound, Integer amount) {
