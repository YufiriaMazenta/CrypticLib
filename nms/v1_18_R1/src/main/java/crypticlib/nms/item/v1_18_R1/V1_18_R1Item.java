...
public class V1_18_R1Item implements Item {
    ...
    public V1_18_R1Item(ItemStack itemStack) {
        ...
        this.nbtCompound = new V1_18_R1NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).t());
    }

    public V1_18_R1Item(String material, AbstractNbtTagCompound nbtCompound) {
