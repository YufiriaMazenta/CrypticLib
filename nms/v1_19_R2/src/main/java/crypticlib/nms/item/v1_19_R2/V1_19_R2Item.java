...
public class V1_19_R2Item extends Item {
    ...
    public V1_19_R2Item(ItemStack itemStack) {
        super(itemStack.getType().name(), new V1_19_R2NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).v()), itemStack.getAmount());
    }
    ...
    public V1_19_R2Item(String material, NbtTagCompound nbtTagCompound, Integer amount) {
