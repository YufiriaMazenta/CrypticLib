...
public class V1_19_R1Item implements Item {
    ...
    public V1_19_R1Item(ItemStack itemStack) {
        ...
        this.nbtCompound = new V1_19_R1NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).v());
    }

    public V1_19_R1Item(String material, AbstractNbtTagCompound nbtCompound) {
