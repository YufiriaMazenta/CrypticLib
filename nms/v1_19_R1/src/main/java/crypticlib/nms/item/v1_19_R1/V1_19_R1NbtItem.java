...
public class V1_19_R1NbtItem extends NbtItem {

    public V1_19_R1NbtItem(@NotNull ItemStack itemStack) {
        super(itemStack);
    }

    public V1_19_R1NbtItem(@NotNull Material material, @NotNull NbtTagCompound nbtTagCompound) {
        super(material, nbtTagCompound);
    }

    public V1_19_R1NbtItem(@NotNull Material material, @NotNull NbtTagCompound nbtTagCompound, @NotNull Integer amount) {
        super(material, nbtTagCompound, amount);
    }

    @Override
    public void fromBukkit() {
        setNbtTagCompound(new V1_19_R1NbtTagCompound(CraftItemStack.asNMSCopy(bukkit).v()));
    }
    ...
    public NbtItem clone() {
        NbtItem clone = new V1_19_R1NbtItem(this.bukkit.clone());
