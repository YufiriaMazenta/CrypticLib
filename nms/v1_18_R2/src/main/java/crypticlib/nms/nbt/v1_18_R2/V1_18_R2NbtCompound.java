...
public class V1_18_R2NbtCompound extends AbstractNbtCompound {

    public V1_18_R2NbtCompound() {
        super(V1_18_R2NbtTranslator.INSTANCE);
    }

    public V1_18_R2NbtCompound(Object nmsNbtCompound) {
        super(nmsNbtCompound, V1_18_R2NbtTranslator.INSTANCE);
    }

    public V1_18_R2NbtCompound(Map<String, Object> nbtValueMap) {
