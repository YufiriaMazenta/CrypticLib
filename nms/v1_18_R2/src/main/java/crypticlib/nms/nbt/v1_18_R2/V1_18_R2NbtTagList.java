...
public class V1_18_R2NbtTagList extends AbstractNbtTagList {

    public V1_18_R2NbtTagList(List<Object> nbtList) {
        super(nbtList, V1_18_R2NbtTranslator.INSTANCE);
    }

    public V1_18_R2NbtTagList(Object nmsNbtList) {
        super(nmsNbtList, V1_18_R2NbtTranslator.INSTANCE);
    }

    public V1_18_R2NbtTagList() {
