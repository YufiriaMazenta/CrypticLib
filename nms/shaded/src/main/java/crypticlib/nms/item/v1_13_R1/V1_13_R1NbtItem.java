...
public class V1_13_R1NbtItem extends NbtItem {

    public V1_13_R1NbtItem(@NotNull ItemStack itemStack) {
        super(itemStack);
    }

    public V1_13_R1NbtItem(@NotNull Material material, @NotNull NbtTagCompound nbtTagCompound) {
        super(material, nbtTagCompound);
    }

    public V1_13_R1NbtItem(@NotNull Material material, @NotNull NbtTagCompound nbtTagCompound, @NotNull Integer amount) {
    ...
    public NbtItem clone() {
        NbtItem clone = new V1_13_R1NbtItem(this.bukkit.clone());
