...
public class V1_15_R1Item extends Item {
    ...
    public V1_15_R1Item(ItemStack itemStack) {
        super(itemStack.getType().name(), new V1_15_R1NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).getOrCreateTag()), itemStack.getAmount());
    }
    ...
    public V1_15_R1Item(String material, NbtTagCompound nbtTagCompound, Integer amount) {
    ...
    @Override
    public net.minecraft.server.v1_15_R1.@NotNull ItemStack buildNMS() {
