...
public class V1_16_R1NbtItem extends NbtItem {
    ...
    public V1_16_R1NbtItem(@NotNull Material material, @NotNull NbtTagCompound nbtTagCompound, @NotNull Integer amount) {
    ...
    public ItemStack saveNbtToItem() {
        ...
        net.minecraft.server.v1_16_R1.ItemStack nmsCopy = CraftItemStack.asNMSCopy(tmpItem);
        nmsCopy.setTag(nms);
    ...
    public NbtItem clone() {
        NbtItem clone = new V1_16_R1NbtItem(this.bukkit.clone());
