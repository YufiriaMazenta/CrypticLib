...
public class V1_13_R1Item implements Item {
    ...
    public V1_13_R1Item(ItemStack itemStack) {
        ...
        this.nbtCompound = new V1_13_R1NbtCompound(CraftItemStack.asNMSCopy(itemStack).getOrCreateTag());
    }

    public V1_13_R1Item(String material, AbstractNbtCompound nbtCompound) {
