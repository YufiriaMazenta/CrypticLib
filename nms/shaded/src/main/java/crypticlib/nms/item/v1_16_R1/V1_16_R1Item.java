...
public class V1_16_R1Item implements Item {
    ...
    public V1_16_R1Item(ItemStack itemStack) {
        ...
        this.nbtCompound = new V1_16_R1NbtCompound(CraftItemStack.asNMSCopy(itemStack).getOrCreateTag());
    }

    public V1_16_R1Item(String material, AbstractNbtCompound nbtCompound) {
