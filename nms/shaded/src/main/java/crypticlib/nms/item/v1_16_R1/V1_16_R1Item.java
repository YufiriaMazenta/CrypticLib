package crypticlib.nms.item.v1_16_R1;
...
public class V1_16_R1Item extends Item {
    ...
    public V1_16_R1Item(ItemStack itemStack) {
        super(itemStack.getType().name(), new V1_16_R1NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).getOrCreateTag()), itemStack.getAmount());
    }

    public V1_16_R1Item(String material, NbtTagCompound nbtTagCompound) {
        super(material, nbtTagCompound);
    }

    public V1_16_R1Item(String material, NbtTagCompound nbtTagCompound, Integer amount) {
    ...
    @Override
    public net.minecraft.server.v1_16_R1.@NotNull ItemStack buildNMS() {
