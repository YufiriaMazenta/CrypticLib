...
public class V1_15_R1NbtTagList extends AbstractNbtTagList {

    public V1_15_R1NbtTagList(List<Object> nbtList) {
        super(nbtList, V1_15_R1NbtTranslator.INSTANCE);
    }

    public V1_15_R1NbtTagList(Object nmsNbtList) {
        super(nmsNbtList, V1_15_R1NbtTranslator.INSTANCE);
    }
