...
public class V1_16_R1NbtCompound extends AbstractNbtCompound {

    public V1_16_R1NbtCompound() {
        super(V1_16_R1NbtTranslator.INSTANCE);
    }

    public V1_16_R1NbtCompound(Object nmsNbtCompound) {
        super(nmsNbtCompound, V1_16_R1NbtTranslator.INSTANCE);
    }

    public V1_16_R1NbtCompound(Map<String, Object> nbtValueMap) {
