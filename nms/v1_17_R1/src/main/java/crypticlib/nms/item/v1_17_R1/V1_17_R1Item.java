...
public class V1_17_R1Item extends Item {

    public V1_17_R1Item(ItemStack itemStack) {
        super(itemStack.getType().name(), new V1_17_R1NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).getOrCreateTag()), itemStack.getAmount());
    }

    public V1_17_R1Item(String material, NbtTagCompound nbtTagCompound) {
        super(material, nbtTagCompound);
    }

    public V1_17_R1Item(String material, NbtTagCompound nbtTagCompound, Integer amount) {
