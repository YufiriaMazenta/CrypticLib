...
public class V1_17_R1Item implements Item {
    ...
    public V1_17_R1Item(ItemStack itemStack) {
        ...
        this.nbtCompound = new V1_17_R1NbtTagCompound(CraftItemStack.asNMSCopy(itemStack).getOrCreateTag());
    }

    public V1_17_R1Item(String material, AbstractNbtTagCompound nbtCompound) {
